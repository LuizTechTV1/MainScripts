        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddColorpicker(default, callback, flag)
                    ...
                    uis.InputChanged:Connect(function(input)
                        if dragging_selector and input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
                            colorpicker:RefreshSelector()
                        end
                ...
                function toggle:AddSlider(min, default, max, decimals, callback, flag)
                    ...
                    uis.InputChanged:Connect(function(input)
                        if dragging and input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType.Name == "Touch" then
                            slider:Refresh()
                        end
                    end)
            ...
            function sector:AddColorpicker(text, default, callback, flag)
                ...
                uis.InputChanged:Connect(function(input)
                    if dragging_selector and input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType.Name == "Touch" then
                        colorpicker:RefreshSelector()
                    end
                    if dragging_hue and input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType.Name == "Touch" then
                        colorpicker:RefreshHue()
                    end
                end)
